...
namespace Atkins\Trix\Controller;
...
class BrowseLinksController extends AbstractLinkBrowserController
{
    ...
    protected function initDocumentTemplate(): void
    {
        $this->pageRenderer->getJavaScriptRenderer()->addJavaScriptModuleInstruction(
            JavaScriptModuleInstruction::create('@typo3/trix/trix-link-browser.js')
    ...
    protected function renderLinkAttributeFields(ViewInterface $view): string
    {
        ...
        if ($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['trix']['plugins']['TYPO3Link']['additionalAttributes'] ?? false) {
            $addAttributes = GeneralUtility::trimExplode(',', $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['trix']['plugins']['TYPO3Link']['additionalAttributes'], true);
