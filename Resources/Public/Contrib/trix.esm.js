...
const DEFAULT_ALLOWED_ATTRIBUTES = "style title target href src width height language class".split(" ");
...
const htmlContainsTagName = function (html, tagName) {
  ...
  HTMLSanitizer.setHTML(div, html || "", {
    allowedAttributes: "style title target href src width height language class".split(" ")
  });
      ...
      for (const key in this.attributes) {
          ...
          if (config) {
              if (config.groupTagName) {
                  return makeElement(config.groupTagName, this.attributes)
              }
          }
      }
  }
